...
export type ThemeName = 'red' | 'blue' | 'green' | 'dark' | 'white' | 'marine' | 'margarita' | 'bro';
...
export interface CartItem {
  ...
  notes?: string;
  specialInstructions?: string; // Nuevo campo para notas de usuario (ej: "Sin cebolla")
  description?: string;
...
export interface SaleRecord {
  ...
  customerName?: string;
  isShiftClosed?: boolean; // Indica si esta venta pertenece a un turno ya cerrado
}
